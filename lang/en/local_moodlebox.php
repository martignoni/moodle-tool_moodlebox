...
$string['moodleboxversion'] = 'MoodleBox version';
...
$string['ipforward'] = 'Network IP forwarding';
$string['ipforwarddisable'] = 'Disable IP forwarding';
$string['ipforwardenable'] = 'Enable IP forwarding';
$string['ipforwardonmessage'] = 'IP forwarding on';
$string['ipforwardoffmessage'] = 'IP forwarding off';
